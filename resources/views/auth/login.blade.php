...
@endsection
@section('content')
<div class="auth-page-wrapper pt-5 bg-light">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to {{ $settingsc->appname }}.</p>
                            </div>
                            <div class="p-2 mt-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> {{ $settingsc->appname }}</p>
                    </div>
                </div>
            </div>
        </div>
