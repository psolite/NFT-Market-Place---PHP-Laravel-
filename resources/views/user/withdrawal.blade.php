    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Make a Withdrawal</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('user.withdrawalform') }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        
                        <div class="col-lg-6">
                            <label for="amount" class="form-label">Amount</label>
                            <input type="number" class="form-control" name="amount" placeholder="Amount" step="0.0001" min="0.0001" required>
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="crypto" class="form-label">Choose Payment Method</label>
                            <select class="form-select mb-3" name="crypto" aria-label="Default select example" required>
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" name="wallet" placeholder="wallet" required>
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <div class="text-end">
                                <button onclick="disableButton()" class="btn btn-primary">Save</button>
                            </div>
                        </div>
                    </div>
                    <!--end row-->
