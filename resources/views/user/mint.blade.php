...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.mintNFT') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-12">                            
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="author" value="{{ Auth::user()->name }}" name="author" placeholder="Enter Author name" required>
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                        ...
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="NFTPrice" class="form-label">Price in {{ $settingsc->currency }}</label>
